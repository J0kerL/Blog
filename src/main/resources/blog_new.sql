...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文章分类表';

INSERT INTO `t_category` (`id`, `name`, `slug`, `description`, `sort_order`, `created_at`) VALUES
('2', '后端', 'hou-duan', '记录后端技术栈相关文章', 0, '2026-06-11 13:26:44'),
('7', '测试分类', 'ce-shi-fen-lei', '', 1, '2026-06-11 21:54:32');
...
INSERT INTO `t_comment` (`id`, `post_id`, `parent_id`, `user_id`, `nickname`, `email`, `content`, `status`, `created_at`) VALUES
('1', '1', NULL, '1', '超级管理员', NULL, '写的真好', 0, '2026-06-11 13:32:08'),
('2', '2', NULL, '1', '超级管理员', NULL, '哈喽', 0, '2026-06-11 14:46:53');
...
好了，我的钱包准备开始烧了。', '', 1, 0, 0, '8', '2026-06-11 14:43:26', '2026-06-11 14:43:12', '2026-06-11 21:29:24');
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文章-分类关联表';
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文章-标签关联表';
...
CREATE TABLE `t_tag` (
  ...
  UNIQUE KEY `name` (`name`),
  UNIQUE KEY `slug` (`slug`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文章标签表';

INSERT INTO `t_tag` (`id`, `name`, `slug`, `created_at`) VALUES
('1', 'Redis', '', '2026-06-11 13:27:25');
